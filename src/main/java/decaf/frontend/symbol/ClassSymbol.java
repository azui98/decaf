...
public final class ClassSymbol extends Symbol {
    ...
    public ClassSymbol(String name, ClassType type, ClassScope scope,
    		Pos pos, Tree.Modifiers modifiers) {
        super(name, type, pos);
    ...
    public ClassSymbol(String name, ClassSymbol parentSymbol,
    		ClassType type, ClassScope scope, Pos pos, Tree.Modifiers modifiers) {
        super(name, type, pos);
