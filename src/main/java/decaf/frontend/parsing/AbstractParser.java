...
abstract class AbstractParser {
    ...
    protected SemValue svTypes(List<Tree.TypeLit> types) {
        var v = new SemValue(SemValue.Kind.TYPE_LIST, types.size() == 0 ? Pos.NoPos : types.get(0).pos);
        v.typeList = types;
        return v;
    }
    ...
    protected SemValue svLambdaBlock(Tree.LambdaBlock block) {
    	var v = new SemValue(SemValue.Kind.BLOCK, block == null ? Pos.NoPos : block.pos);
        v.lambdaBlock = block;
        return v;
    }
