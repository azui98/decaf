...
//import decaf.lowlevel.tac.Simulator.Frame;
...
public abstract class TacInstr extends PseudoInstr {
    ...
    public abstract TacInstr map(Map<Temp, Temp> map);
    /**
    ...
    public static class Assign extends TacInstr {
        ...
        public TacInstr map(Map<Temp, Temp> map) {
        	return new Assign(map.get(dst), map.get(src));
        }
    ...
    public static class LoadVTbl extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	return new LoadVTbl(map.get(dst), vtbl);
        }
    ...
    public static class LoadImm4 extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	return new LoadImm4(map.get(dst), value);
        }
    ...
    public static class LoadStrConst extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	return new LoadStrConst(map.get(dst), value);
        }
    ...
    public static class Unary extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	return new Unary(op, map.get(dst), map.get(operand));
        }
    ...
    public static class Binary extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	return new Binary(op, map.get(dst), map.get(lhs), map.get(rhs));
        }
    ...
    public static class CondBranch extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	return new CondBranch(op, map.get(cond), target);
        }
    ...
    public static class Return extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	if (value.isPresent()) return new Return(map.get(value.get()));
        	return this;
        }
    ...
    public static class IndirectCall extends TacInstr {
        ...
        public TacInstr map(Map<Temp, Temp> map) {
        	if (dst.isPresent())
        		return new IndirectCall(map.get(dst.get()), map.get(entry));
        	else
        		return new IndirectCall(map.get(entry));
        }
    ...
    public static class DirectCall extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	if (dst.isEmpty()) return this;
        	return new DirectCall(map.get(dst.get()), entry);
        }
    ...
    public static class Memory extends TacInstr {
        ...
        @Override
        public TacInstr map(Map<Temp, Temp> map) {
        	/*if (op == Op.STORE && map.get(dst) == null) {
        		System.out.println("aaaaaaaaaaaaa     " + dst);
        		System.out.println("bbbbbbbbbbbbb     " + map.get(dst));
        		System.out.println(map);
        	}*/
        	return new Memory(op, map.get(dst), map.get(base), offset);
        }
